...
public interface PropertyResolver {
	 ...
	 * {@code Class} of type {@code T} or {@code null} if the key cannot be
	 * resolved.
	 * 
	 * @throws org.springframework.core.convert.ConversionException
	 *             if class specified by property value cannot be found or
	 *             loaded or if targetType is not assignable from class
	 *             specified by property value
	 * @see #getProperty(String, Class)
	 */
