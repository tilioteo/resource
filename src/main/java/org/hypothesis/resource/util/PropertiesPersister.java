...
/**
 * Strategy interface for persisting {@code java.util.Properties}, allowing for
 * pluggable parsing strategies.
 *
 * <p>
 * The default implementation is DefaultPropertiesPersister, providing the
 * native parsing of {@code java.util.Properties}, but allowing for reading from
 * any Reader and writing to any Writer (which allows to specify an encoding for
 * a properties file).
 *
 * <p>
 * As of Spring 1.2.2, this interface also supports properties XML files,
 * through the {@code loadFromXml} and {@code storeToXml} methods. The default
...
public interface PropertiesPersister {
	...
	/**
	 * Load properties from the given InputStream into the given Properties
	 * object.
	 * 
	 * @param props
	...
	/**
	 * Load properties from the given XML InputStream into the given Properties
	 * object.
	 * 
	 * @param props
	 *            the Properties object to load into
