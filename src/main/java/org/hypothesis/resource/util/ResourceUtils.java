 ...
 * {@link org.hypothesis.core.io.springframework.core.io.ResourceLoader}'s
 * {@code getResource()} method can resolve any location to a
 * {@link org.hypothesis.core.io.springframework.core.io.Resource} object, which
 * in turn allows one to obtain a {@code java.io.File} in the file system
 * through its {@code getFile()} method.
 *
 * <p>
 ...
 * @see org.hypothesis.core.io.springframework.core.io.ResourceLoader
 */
